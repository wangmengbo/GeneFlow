...
def main():
    ...
    parser.add_argument('--gene_expr', type=str, required=True, help='Path to gene expression CSV file.')
    parser.add_argument('--image_paths', type=str, help='Path to JSON file with image paths.')
    parser.add_argument('--patch_image_paths', type=str, help='Path to JSON file with patch paths.')
    parser.add_argument('--patch_cell_mapping', type=str, help='Path to JSON file with mapping paths.')
    ...
    with open(os.path.join(args.output_dir, 'diffusion_metrics.json'), 'w') as f:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(args.output_dir, 'diffusion_metric_distributions.png'))
